...
fake = setting.fake
ownerName = 'Laras Botz'
ownerNumber = '6285759662798'
aktor = '𝙸𝚝𝚜𝚖𝚎`𝙻𝚊𝚛𝚊𝚜'
Yanz = '```'
...
async function starts() {
	...
	YANZ.on('qr', () => {
		YANZ.sendMessage("6285759662798@s.whatsapp.net", `「 BOT CONNECT 」\n\n${Laras}Hallo Kak!! Saya ${ownerName} Izin Menggunakan Bot Ini!!${Laras}\n\n${Laras}BOT TERSAMBUNG PADA${Laras}\n${Laras}${time2}${Laras}\n\n${Laras}PROFILE${Laras}\n*Nama* : ${ownerName}\n*Nomor* : ${ownerNumber}\n*Status* : Online\n\n${Laras}TERIMAKASIH KAK LARAS!!${Laras}`, MessageType.extendedText)
...
`
				...
				case 'help':
					...
					ptod = "6285759662798@s.whatsapp.net"
...
_Selamat datang di sewa bot BY Laras Bot🌸_`
